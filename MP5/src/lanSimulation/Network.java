...
public class Network {
	 ...
	 *         #false otherwise
	 */
	public boolean LoopEnd (Packet packet, Node currentNode,boolean broaddcast){
		if(broaddcast) {
	...
	public boolean requestBroadcast(Writer report) {
		...
		do {
			...
			currentNode = currentNode.nextNode;
		} while (LoopEnd(packet,currentNode,true));
	...
	public boolean requestWorkstationPrintsDocument(String workstation,
		...
		while (LoopEnd(packet,currentNode,false)) {
			try {
				report.write("\tNode '");
				report.write(currentNode.name);
				report.write("' passes packet on.\n");
	...
	public void printOn(StringBuffer buf) {
		Node currentNode = firstNode;
		do {
			currentNode.stringbuffer(buf,false);
			buf.append(" -> ");
			currentNode = currentNode.nextNode;
	...
	public void printXMLOn(StringBuffer buf) {
		...
		do {
			buf.append("\n\t");
			currentNode.stringbuffer(buf,true);
			currentNode = currentNode.nextNode;
		} while (currentNode != firstNode);
		buf.append("\n</network>");
	}
